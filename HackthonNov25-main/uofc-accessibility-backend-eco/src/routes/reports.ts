...
heatTilesRouter.get('/:z/:x/:y.mvt', async (req: Request, res: Response)=>{
  ...
  const buff = vtpbf.fromGeojsonVt({ heat: tile as any });
  res.setHeader('Content-Type', 'application/x-protobuf');
...
poisRouter.get('/', async (_req: Request, res: Response)=>{
